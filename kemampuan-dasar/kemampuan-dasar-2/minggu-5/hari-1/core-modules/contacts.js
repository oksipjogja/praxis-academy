...
// cek no Handphone
    ...
    if(!validator.isMobilePhone(noHP, 'id-ID')) {
        console.log(
            chalk.red.inverse.bold('Masukan No Handphone yang benar!')
        );
        return false; 
...
// cek duplikat
    ...
    if(duplikat) {
        console.log(
            chalk.red.inverse.bold('Contact sudah terdaftar, silahkan gunakan nama lain!')
        );
        return false;
    }
...
const detailContact = (nama) => {
    ...
    if(!contact) {
        console.log(
            chalk.red.inverse.bold(`${nama} tidak valid`));
        return false;
    }
...
const removeContact = (nama) => {
    ...
    console.log(
        chalk.white.green.inverse.bold(`data kontak ${nama} berhasil dihapus!`));
};
